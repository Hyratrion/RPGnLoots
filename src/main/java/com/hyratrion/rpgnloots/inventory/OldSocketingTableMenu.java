...
public class OldSocketingTableMenu extends ItemCombinerMenu
{
    ...
    public OldSocketingTableMenu(int p_39005_, Inventory p_39006_) {
        this(p_39005_, p_39006_, ContainerLevelAccess.NULL);
    }

    public OldSocketingTableMenu(int p_39008_, Inventory p_39009_, ContainerLevelAccess p_39010_) {
        super(MenuType.ANVIL, p_39008_, p_39009_, p_39010_);
        System.out.println("Test entrée menu Socketing talbe");
    ...
    protected void onTake(Player p_150474_, ItemStack p_150475_) {
        ...
        float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(p_150474_, p_150475_, OldSocketingTableMenu.this.inputSlots.getItem(0), OldSocketingTableMenu.this.inputSlots.getItem(1));
