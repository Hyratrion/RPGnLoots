...
public class ModItems
{
    ...
    public static final RegistryObject<Item> PLIERS = ITEMS.register("pliers",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.RPGNLOOTS_TAB)));

    public static final RegistryObject<Item> SOCKETING_TABLE = block(ModBlocks.SOCKETING_TABLE, ModCreativeTab.RPGNLOOTS_TAB);
    ...
    {
        Component result;
        TagKey<Item> itemType = Gems.GetGemType(gem);
        ...
        if(itemType != null)
        {
            ...
            float value = Gems.GetGemValue(gem);

            boolean showPercent = Gems.GemIsType(gem, ModTags.Items.GEM_PERCENT);
